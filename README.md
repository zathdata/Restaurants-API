...
A simple REST API built with Python, Flask, and PostgreSQL that serves data that was randomly generated by AI.
...
3.  **Set up the database:**
    ...
    * Create a table named `restaurants` using the schema from the `load_data.py` script.
